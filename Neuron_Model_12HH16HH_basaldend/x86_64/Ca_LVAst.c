...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_LVAst /NG/Neuron_Model_12HH16HH/mechanisms/Ca_LVAst.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/NG/Neuron_Model_12HH16HH/mechanisms/Ca_LVAst.mod";
static const char* nmodl_file_text = 
