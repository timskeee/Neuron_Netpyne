...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," \"./mechanisms/Ca_Ltype.mod\"");
    ...
    fprintf(stderr," \"./mechanisms/na12HH.mod\"");
    fprintf(stderr," \"./mechanisms/na12HHmut.mod\"");
    fprintf(stderr," \"./mechanisms/na16HH.mod\"");
    fprintf(stderr," \"./mechanisms/na16HHmut.mod\"");
